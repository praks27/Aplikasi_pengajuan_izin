...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Menunggu Approval</h1>
			</div><!-- /.col-lg-12 -->
		</div><!-- /.row -->
						...
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									<a href="cuti_delete.php?no=<?php echo $data['no_cuti']; ?>&username=<?= $data['username']; ?>" onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan cuti ?');" class="btn btn-danger btn-xs btn_hps">Hapus</a></td>
								<?php
									echo '</td>';
									echo '</tr>';
									$i++;
