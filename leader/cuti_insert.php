...
if($durasi>$jml){
	...
	$sql 	= "INSERT INTO cuti (no_cuti, username, tgl_pengajuan, tgl_awal, tgl_akhir, durasi, keterangan, spv, stt_cuti) 
				VALUES ('$id','$username','$ajuan','$mulai','$akhir','$durasi','$ket','$spv','$stt')";
