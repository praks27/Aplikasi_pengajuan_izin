...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Semua Data Izin</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.username=employee.username ORDER BY cuti.tgl_pengajuan DESC";
