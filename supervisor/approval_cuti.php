				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.username=employee.username AND 
										cuti.spv='$id' AND cuti.stt_cuti='Menunggu Approval Supervisor' ORDER BY cuti.wkt_pengajuan DESC, cuti.tgl_pengajuan DESC";
						...
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									echo '<td class="text-center">'. $data['wkt_pengajuan'] .'</td>';
