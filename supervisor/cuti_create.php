					...
					<div class="panel panel-default">
						...
						<div class="panel-body" id="form-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<textarea name="keterangan" id="ket" class="form-control" placeholder="Keterangan" rows="3"></textarea>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<select name="HOD" id="HOD" class="form-control" required>
										<option value="" selected>======== Pilih HOD ========</option>
										<?php
										$mySql = "SELECT * FROM employee WHERE hak_akses='HOD' AND active='Aktif' ORDER BY nama_emp";
										$myQry = mysqli_query($conn, $mySql);
						...
						<div class="panel-footer">
							<button type="submit" name="simpan" id="btnsubmit" class="btn btn-success">Simpan</button>
						</div>
					</div><!-- /.panel -->
				</form>
			</div><!-- /.col-lg-12 -->
