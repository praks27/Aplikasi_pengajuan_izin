						...
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									<a href="cuti_delete.php?no=<?php echo $data['no_cuti']; ?>&username=<?= $data['username']; ?>" onclick="return confirm('Apakah anda yakin akan membatalkan permohonan izin No. <?php echo $data['no_cuti']; ?>?');" class="btn btn-danger btn-xs btn_hps">Hapus</a></td>
								<?php
									echo '</td>';
									echo '</tr>';
									$i++;
