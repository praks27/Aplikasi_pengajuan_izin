<?php
	...
	$sqlb = "SELECT * FROM cuti WHERE username='$id' AND stt_cuti!='Rejected'";
	$ressb = mysqli_query($conn, $sqlb);
	$b = mysqli_num_rows($ressb);

	$sqlc = "SELECT * FROM cuti WHERE username='$id' AND stt_cuti='Rejected'";
	$ressc = mysqli_query($conn, $sqlc);
	$c = mysqli_num_rows($ressc);

	$sqla = "SELECT * FROM cuti WHERE username='$id' AND hrd_app=1";
	$ressa = mysqli_query($conn, $sqla);
	$a = mysqli_num_rows($ressa);

	$sqld = "SELECT * FROM cuti WHERE spv='$id' AND stt_cuti='Menunggu Approval Supervisor'";
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal">
							<div class="panel panel-default">
								<div class="panel-body">
								<h2 align="center">Approval Pengajuan</h2>
								</div>
							</div><!-- /.panel -->
						</form>
					</div><!-- /.col-lg-12 -->
