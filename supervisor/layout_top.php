...
<head>
	...
	<title>Pengajuan Izin Online PT. Tjahaja Agung Tunggal- <?php echo $pagedesc ?></title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown dropdown-right">
					...
					<i class="fa fa-user fa-fw"></i>&nbsp;<?php echo ucfirst($sess_spvname); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
					...
					<ul class="nav" id="side-menu">
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Approval") {
								echo '<li><a href="approval_cuti.php" class="active">Approval</a></li>';
							} else {
								echo '<li><a href="approval_cuti.php">Approval</a></li>';
							}
						...
						?>
						<!-- open <li> tag generated with php, see line 155-160 -->
						<a href="#"><i class="fa fa-recycle fa-fw"></i>&nbsp;Permohonan Izin<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php
