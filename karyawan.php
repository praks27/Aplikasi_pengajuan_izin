										...
										<?php
											...
											while($data = mysqli_fetch_array($ress)) {
												...
												echo '<td class="text-center">
													  <a href="#myModal" data-toggle="modal" data-load-code="'.$data['username'].'" data-remote-target="#myModal .modal-body" class="btn btn-primary btn-xs">Detail</a>
													  <a href="karyawan_edit.php?username='. $data['username'] .'" class="btn btn-warning btn-xs">Edit</a>';?>
													  <a href="karyawan_hapus.php?username=<?php echo $data['username'];?>" onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $data['nama_emp'];?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
